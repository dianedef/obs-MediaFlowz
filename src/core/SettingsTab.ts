    ...
    display(): void {
        ...
        new Setting(containerEl)
            ...
            .addDropdown(dropdown => dropdown
                ...
                .onChange(async (value: 'extra-small' | 'small' | 'medium' | 'large' | 'extra-large') => {
        ...
        if (this.plugin.settings.showImageToolbar) {
            ...
            new Setting(toolbarSection)
                ...
                .setDesc('Permet de redimensionner l\'image avec ALT + molette de la souris')
                .addToggle(toggle => toggle
        ...
        // Section des fonctionnalités
        containerEl.createEl('h2', { text: 'Fonctionnalités' });

        new Setting(containerEl)
            .setName('Redimensionnement des images')
            .setDesc('Permet de redimensionner les images avec ALT + Molette de la souris')
            .addToggle(toggle => toggle
        ...
        new Setting(storageZonesSection)
            ...
            .addButton(button => button
                ...
                .onClick((e: MouseEvent) => {
                    ...
                    // Utiliser buildFolderMenu avec un callback pour les zones de stockage
                    this.buildFolderMenu(menu, this.app.vault.getRoot(), (folder: TFolder) => {
                        ...
                        // Utiliser la classe de style globale
